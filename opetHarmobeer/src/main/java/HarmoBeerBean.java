...
public class HarmoBeerBean implements Serializable {
	...
	/**
	 * Metodo para logar no sistema. Antes de checar as credenciais de entrada, o
	 * metodo atualiza as medias das harmonizacoes.
	 * 
	 ...
	 * 
	 * @return pagina de alteracao confirmada ou pagina de erro durante alteracao.
	 */
	 ...
	 * objeto criado no bean e setando seus parametros. Gera um Array com o ranking
	 * das harmonizacoes dessa cerveja.
	 */
	...
	/**
	 * Metodo que seta um Array List <Prato> com os pratos que contem determinada
	 * String.
	 * 
	...
	/**
	 * Metodo que seleciona um prato em uma lista, setando os parametros necessarios
	 * para a tela e gerando um ranking para esse prato.
	 */
	...
	/**
	 * Metodo utilizado para incluir uma avaliacao no banco de dados pelo usuario
	 * logado
	 * 
	 ...
	 * por ele para colocar em tela quando necessario.
	 */
	...
	/**
	 * Metodo para selecionar uma avaliacao, setando os parametros necessarios em
	 * tela para edicao.
	 */
	...
	/**
	 * Delecao de usuario pelo administrador, transformando-o em um usuario anonimo.
	 * 
	 * @param idUser
	 * @return pagina de administracao ou de erro
	 */
	...
	/**
	 * Deleção de avaliacao de outro usuario pelo administrador. Seta comandos de
	 * telas.
	 * 
	 * @param idAval - aval a ser deletada
	...
	/**
	 * Seta varios parametros para um estado neutro e retorna para o menu principal.
	 * 
	...
	/**
	 * @param pSenhaconf the senhaconf to set
	 */
	...
	/**
	 * @param pIdUsuarioSelecionado the idUsuarioSelecionado to set
	 */
	...
	/**
	 * @param pUsernameSelec the usernameSelec to set
	 */
	...
	/**
	 * @param pInfoSelec the infoSelec to set
	 */
	...
	/**
	 * @param adminListaCerv the adminListaCerv to set
	 */
	...
	/**
	 * @param adminListaPrato the adminListaPrato to set
	 */
	...
	/**
	 * @param adminListaUser the adminListaUser to set
	 */
	...
	/**
	 * @param adminListaAval the adminListaAval to set
	 */
	...
	/**
	 * @param pUsuarioLogado the usuarioLogado to set
	 */
	...
	/**
	 * @param pUsuarioCadastrado the usuarioCadastrado to set
	 */
	...
	/**
	 * @param pUsuarioSelecionado the usuarioSelecionado to set
	 */
	...
	/**
	 * @param cervejaAdmin the cervejaAdmin to set
	 */
	...
	/**
	 * @param pratoAdmin the pratoAdmin to set
	 */
	...
	/**
	 * @param pRanking the ranking to set
	 */
