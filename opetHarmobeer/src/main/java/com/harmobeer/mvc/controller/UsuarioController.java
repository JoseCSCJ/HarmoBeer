...
public class UsuarioController implements IUsuarioDAO {
	...
	private boolean validarUsuario(Usuario user) {
		...
		System.out.println("testee antes do user" + username + " " + email + " " + senha + " " + info);
		if (username.length() > 20) {
			System.out.println("Username muito longo");
			return false;
		}
		System.out.println("testee antes do email" + username + " " + email + " " + senha + " " + info);
		if (email.length() > 50) {
			System.out.println("Email muito longo");
			return false;
		}
		System.out.println("testee antes da senha" + username + " " + email + " " + senha + " " + info);
		if (senha.length() > 20) {
